...
static ColorInfo color_info(Color::Palette16 index) {
    return palette256[index];
}

static ColorInfo color_info(Color::Palette256 index) {
    return palette256[index];
}
...
Color::Color(Palette1 palette) : _type(ColorType::Palette1) {}

Color::Color(Palette16 palette) : _type(ColorType::Palette16), _red(palette) {}

Color::Color(Palette256 palette) : _type(ColorType::Palette256), _red(palette) {
}
